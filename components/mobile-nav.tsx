...
import DarkModeSwitch from "./dark-button"
...
const MobileNav = () => {
    ...
    return (
        <div className="[@media(min-width:700px)]:hidden">
            ...
            <div
                className={`fixed left-0 top-0 z-10 size-full bg-gray-200 opacity-95 duration-300 ease-in-out dark:bg-black ${navShow ? "translate-x-0" : "translate-x-full"
                    }`}
            >
                <div className="flex justify-end">
                    <button
                        className="mr-5 rounded mt-11 size-8"
                        aria-label="Toggle Menu"
                        onClick={onToggleNav}
                    >
                        <svg
